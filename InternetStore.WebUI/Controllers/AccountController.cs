...
using InternetStore.WebUI.Filters;
        ...
        public class AccountController : Controller
        {
            ...
            public ActionResult Register(RegisterModel model)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new { model.FirstName, model.LastName, model.Email, model.HomeAddress});
                        Roles.AddUserToRole(model.UserName, "Buyer");
